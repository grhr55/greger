...
export default function Sposok() {
  ...
  <p className="text-lg text-amber-50 md:text-2xl font-black italic">{item.rating} / 5.0</p>
                ...
                <div className="w-full md:w-auto flex flex-col gap-3">
                  <button className="bg-yellow-400 hover:bg-green-500 text-black font-black py-4 px-8 rounded-xl transition-all transform hover:scale-105 shadow-[0_5px_15px_rgba(251,191,36,0.3)] uppercase italic tracking-tighter text-lg">
                    Jogar Agora
                  </button>
